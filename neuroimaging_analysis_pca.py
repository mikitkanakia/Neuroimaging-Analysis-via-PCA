...
# MAGIC %md ### **Part 1: Work through the steps of PCA on a sample dataset**

# COMMAND ----------

# MAGIC %md #### **Visualization 1: Two-dimensional Gaussians**
...
# MAGIC #### Note that `correlatedData` is an RDD of NumPy arrays.  This allows us to perform certain operations more succinctly.
...
# MAGIC %md #### **(1b) Sample covariance matrix**
...
# MAGIC %md #### **(1c) Covariance Function**
...
# MAGIC %md #### **(1d) Eigendecomposition**
...
# MAGIC %md ### **Part 2: Write a PCA function and evaluate PCA on sample datasets**

# COMMAND ----------

# MAGIC %md #### **(2a) PCA function**
...
# MAGIC %md #### **Visualization 2: PCA projection**
...
# MAGIC %md #### **Visualization 3: Three-dimensional data**
...
# MAGIC %md #### **(2c) 3D to 2D**
# MAGIC #### We will now use PCA to see if we can recover the 2-dimensional plane on which the data live. Parallelize the data, and use our PCA function from above, with k=2 components.
...
# MAGIC %md #### **Visualization 4: 2D representation of 3D data**
...
# MAGIC %md #### **(2d) Variance explained**
# MAGIC #### Finally, let's quantify how much of the variance is being captured by PCA in each of the three synthetic datasets we've analyzed.  To do this, we'll compute the fraction of retained variance by the top principal components.
...
# MAGIC %md ### **Part 3:  Parse, inspect, and preprocess neuroscience data then perform PCA **

# COMMAND ----------

# MAGIC %md #### **Data introduction**
...
# MAGIC %md #### **(3a) Load neuroscience data**
...
# MAGIC %md #### **(3b) Parse the data**
# MAGIC #### Parse the data into a key-value representation. We want each key to be a tuple of two-dimensional spatial coordinates and each value to be a NumPy array storing the associated time series.
...
# MAGIC %md #### **(3c) Min and max flouresence**
# MAGIC #### Next we'll do some basic preprocessing on the data. The raw time-series data are in units of image flouresence, and baseline flouresence varies somewhat arbitrarily from pixel to pixel.

# COMMAND ----------

mn = rawData.map(lambda (k, v): v).map(lambda v: min(v)).min()
...
# MAGIC %md #### **Visualization 5: Pixel intensity**
...
# MAGIC %md #### **(3d) Fractional signal change**
...
# MAGIC %md #### **Visualization 6: Normalized data**
...
# MAGIC %md #### **Visualization 7: Top two components as images**
...
# MAGIC %md #### **Visualization 8: Top two components as one image**
...
# MAGIC %md ### **Part 4: Feature-based aggregation and PCA**

# COMMAND ----------

# MAGIC %md #### **(4a) Aggregation using arrays**
# MAGIC  
...
# MAGIC %md #### **(4c) Obtain a compact representation**
# MAGIC #### We now have a time-aggregated dataset with n = 46460 pixels and d = 20 aggregated time features, and we want to use PCA to find a more compact representation.
...
# MAGIC %md #### ** Visualization 9: Top two components by time **
...
# MAGIC %md #### **(4d) Aggregate by direction**
...
# MAGIC %md #### **(4e) Compact representation of direction data**
# MAGIC #### We now have a direction-aggregated dataset with n = 46460 pixels and d = 12 aggregated direction features, and we want to use PCA to find a more compact representation.
...
# MAGIC %md #### **Visualization 10: Top two components by direction**
